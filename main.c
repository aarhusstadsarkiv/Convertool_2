...
{   
    ...
    ConvertArgs args = {.db_path=db_path, .file_count=10, .max_errs=5, .outdir=outdir, .root_data_path="/mnt/d/Staging/Processing/AVID.AARS.22.1/OriginalDocuments/", .convertermaps=maps};
    convert(&args);
    return 0;
}
